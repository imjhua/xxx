  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        !isActive && 'hover:bg-sidebar-hover hover:text-sidebar-hover-foreground',
        size === 'sm' && 'text-xs',
        size === 'md' && 'text-sm',
        'group-data-[collapsible=icon]:hidden',
        className
